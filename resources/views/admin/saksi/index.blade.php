            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div>
                            <a href="{{ url('saksi/pilih-anggota') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                                Tambah saksi</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-success"
                                                    href="{{ url('saksi/' . $item->saksi->id . '/edit') }}"><i
                                                        class="fas fa-pen"></i></a>

                                                <form style="display:inline-block" action="{{ url('saksi/' . $item->id) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
