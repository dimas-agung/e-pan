                                        ...
                                        <div class="form-group">
                                            ...
                                            <select disabled name="status_perkawinan" id="status_perkawinan"
                                                ...
                                                <option value="Menikah" @selected($anggota->status_perkawinan == 'Menikah')>
                                                    Menikah</option>
                                                <option value="Pernah Menikah" @selected($anggota->status_perkawinan == 'Pernah Menikah')>Pernah
                                                    Menikah</option>
                                                <option value="Belum Menikah" @selected($anggota->status_perkawinan == 'Belum Menikah')>Belum
                                                    Menikah</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select disabled name="pekerjaan" id="pekerjaan" class="form-control"
                                                ...
                                                <option value="Pegawai Negeri Sipil" @selected($anggota->pekerjaan == 'Pegawai Negeri Sipil')>
                                                    Pegawai
                                                    Negeri Sipil</option>
                                                <option value="Karyawan BUMN" @selected($anggota->pekerjaan == 'Karyawan BUMN')>Karyawan
                                                    BUMN
                                                </option>
                                                <option value="Karyawan Swasta" @selected($anggota->pekerjaan == 'Karyawan Swasta')>Karyawan
                                                    Swasta</option>
                                                <option value="Wirausaha" @selected($anggota->pekerjaan == 'Wirausaha')>
                                                    Wirausaha
                                                </option>
                                                <option value="Pelajar/Mahasiswa" @selected($anggota->pekerjaan == 'Pelajar/Mahasiswa')>
                                                    Pelajar/Mahasiswa</option>
                                                <option value="Mengurus Rumah Tangga" @selected($anggota->pekerjaan == 'Mengurus Rumah Tangga')>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="telpon" id="telpon"
                                                class="form-control" required value="{{ $anggota->telpon }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="data-alamat">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="provinsi" id="provinsi"
                                                class="form-control" value="{{ $anggota->provinsi }}" required />
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="kabupaten" id="kabupaten"
                                                class="form-control" value="{{ $anggota->kabupaten }}" required />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="kecamatan" id="kecamatan"
                                                class="form-control" value="{{ $anggota->kecamatan }}" required />
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="desa" id="desa"
                                                class="form-control" required value="{{ $anggota->desa }}" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea disabled name="alamat" id="alamat" cols="30" rows="2" class="form-control" required>{{ $anggota->alamat }}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>RT</label>
                                            <input readonly type="text" name="rt" id="rw"
                                                class="form-control" value="{{ $anggota->rt }}" required />
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <label>RW</label>
                                            <input readonly type="text" name="rw" id="rw"
                                                class="form-control" value="{{ $anggota->rw }}" required />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset('storage/' . $anggota->url_ktp) }}" alt="">
